...
function FormCard({ user,handleRemove,id }) {
  return (
    <div className='w-52  bg-zinc-100 rounded-lg flex flex-col items-center p-2'>
      ...
      <p className='mt-2 text-center text-xs font-semibold leading-1 tracking-tight'>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati voluptate fuga provident.
      </p>
      <button onClick={()=>handleRemove(id)} className='px-3 py-1 bg-red-600 text-xs rounded-lg font-semibold text-white mt-4'>
        Remove It
      </button>
    </div>
  );
